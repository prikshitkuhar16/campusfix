    ...
    Scaffold(
        ...
        Box(
            ...
            when (val state = complaintsState) {
                is StudentComplaintsUiState.Loading -> {
                    CircularProgressIndicator(
                        modifier = Modifier.align(Alignment.Center)
                    )
                }

                is StudentComplaintsUiState.Empty -> {
                    Column(
                        modifier = Modifier.align(Alignment.Center),
                        ...
                        Text(
                            text = "Raise a complaint to get started",
                ...
                is StudentComplaintsUiState.Success -> {
                    LazyColumn(
                ...
                is StudentComplaintsUiState.Error -> {
                    Column(
                        modifier = Modifier.align(Alignment.Center),
                        horizontalAlignment = Alignment.CenterHorizontally
                    ) {
                        ...
                        Spacer(modifier = Modifier.height(16.dp))
                        Button(onClick = { viewModel.loadMyComplaints() }) {
                            Text("Retry")
                        }
                    }
                }
...
@Composable
private fun StudentComplaintCard(
    ...
    Card(
        ...
        Column(
            ...
            // Building / Location
            val location = listOfNotNull(complaint.location, complaint.room)
...
@Composable
fun StudentStatusChip(status: String) {
